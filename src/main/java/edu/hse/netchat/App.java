...
public final class App {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (cliArgs.listen().isPresent() && cliArgs.peer().isPresent()) {
      System.err.println("Using --listen together with --peer is not supported in базовой версии.");
      System.exit(2);
      return;
    }
    ...
    if (cliArgs.peer().isPresent()) {
      ...
      InetSocketAddress listen = cliArgs.listen().orElseGet(() -> new InetSocketAddress("0.0.0.0", 0));
